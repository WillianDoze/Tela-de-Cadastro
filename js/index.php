...
<body>
  <main>
    ...
    <section id="login">
      <p id="aparecerAdm" style="display: none;text-align: center">Acesso administrador <?php if (isset($_SESSION["login"])) echo $_SESSION["login"] ?></p>
      <div id="campos">
        ...
        <input id="unico1" type="hidden">
        <p id="erro" type="hidde"></p>
      </div>
